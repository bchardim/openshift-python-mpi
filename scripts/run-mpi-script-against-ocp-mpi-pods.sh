...
echo
echo "Run mpi script"
echo "oc rsh ${mpi_pod_head} mpirun -n ${mpi_pods_count} -H ${mpi_host_list} scl enable rh-python36 ${mpi_scripts_dir}/$1"
oc rsh ${mpi_pod_head} mpirun -n ${mpi_pods_count} -H ${mpi_host_list} scl enable rh-python36 ${mpi_scripts_dir}/$1
